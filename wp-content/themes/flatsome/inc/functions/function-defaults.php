...
if(!function_exists('flatsome_defaults')){
  function flatsome_defaults($option) {
    $df = array(
      ...
      // Follow icons
      'follow_style' => 'small',
      'follow_facebook' => 'http://vifonic.vn/',
      'follow_twitter' => 'http://vifonic.vn/',
      'follow_instagram' => 'http://vifonic.vn/',
      'follow_google' => 'http://vifonic.vn/',
      ...
      'type_alt' => array('font-family'=> 'Roboto'),
      ...
      'blog_show_excerpt' => 1,
      'wc_account_links' => 1,
      'footer_left_text' => 'Copyright [ux_current_year] &copy; <strong>Vifonic</strong>', // Sanitaize
